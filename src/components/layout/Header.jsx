      ...
      <nav className="container-custom mx-auto px-5 md:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-18 lg:h-20">
            ...
            {navItems.map((item) => (
              ...
              >
                ...
                {isActive(item.path) && (
                  <motion.span
                    layoutId="active-underline"
                    className="absolute -bottom-1 left-4 right-4 h-0.5 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full"
                    transition={{ type: 'spring', stiffness: 400, damping: 30 }}
                  />
                )}
              </Link>
          ...
          <button
            ...
            className="md:hidden p-2.5 -mr-2.5 text-gray-700 hover:text-blue-600 active:text-blue-700 transition-colors"
            aria-label={mobileMenuOpen ? 'Close menu' : 'Open menu'}
          >
            <motion.div
              animate={{ rotate: mobileMenuOpen ? 90 : 0 }}
