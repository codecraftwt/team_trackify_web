...
const About = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 md:pt-40 md:pb-32 bg-gradient-to-br from-blue-50 via-white to-blue-50">
        <div className="container-custom">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            className="text-center max-w-3xl mx-auto"
          >
            <div className="inline-block bg-blue-50 text-blue-600 font-semibold text-sm px-4 py-2 rounded-full mb-6">
              About Us
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              About <span className="text-blue-600">Team Trackify</span>
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed">
              We're on a mission to revolutionize how businesses track and manage
              their teams. With cutting-edge technology and a passion for innovation,
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                transition={{ duration: 0.55, delay: index * 0.14 }}
                whileHover={{ y: -6, scale: 1.015 }}
                className="group relative bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-lg hover:border-blue-200/60 transition-all duration-300 ease-out overflow-hidden"
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-25 transition-opacity duration-400`}
                />
      ...
      {/* Mission Section */}
      <section className="section-padding bg-gradient-to-r from-blue-600 to-blue-400 text-white">
        <div className="container-custom text-center">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
