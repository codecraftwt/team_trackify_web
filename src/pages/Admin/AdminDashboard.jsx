...
const CurrentPlan = ({ planData, loading, onPurchasePlan, isSubAdmin }) => {
  ...
  if (!planData) {
    return (
      ...
      >
        ...
        >
          <Box sx={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, background: `radial-gradient(circle at 30% 20%, ${alpha(theme.palette.primary.main, 0.03)} 0%, transparent 70%)`, pointerEvents: "none" }} />
          <Box sx={{ position: "relative", zIndex: 1 }}>
            <Box sx={{ width: { xs: 60, sm: 80, md: 100 }, height: { xs: 60, sm: 80, md: 100 }, borderRadius: "50%", bgcolor: alpha(theme.palette.primary.main, 0.1), display: "flex", alignItems: "center", justifyContent: "center", mx: "auto", mb: 2 }}>
              <ShoppingBagIcon sx={{ fontSize: { xs: 30, sm: 40, md: 50 }, color: theme.palette.primary.main }} />
            </Box>
            <Typography variant={isMobile ? "h6" : "h5"} fontWeight="700" sx={{ fontSize: { xs: '1rem', sm: '1.2rem', md: '1.4rem' }, color: 'text.primary', mb: 1 }}>
              No Active Plan
            </Typography>
            <Typography variant="body2" color="text.secondary" sx={{ fontSize: { xs: '0.7rem', sm: '0.75rem', md: '0.8rem' }, mb: 2.5, maxWidth: 400, mx: 'auto' }}>
              {isSubAdmin
                ? "You don't have an active subscription plan. Please contact your admin to purchase a plan."
                : "You don't have an active subscription plan. Purchase a plan to start tracking your users and accessing all features."}
            </Typography>
            {!isSubAdmin && (
              <Button
                ...
                sx={{
                  ...
                  boxShadow: `0 8px 16px -5px ${alpha(theme.palette.primary.main, 0.3)}`,
                  '&:hover': { transform: 'translateY(-2px)', boxShadow: `0 12px 24px -8px ${alpha(theme.palette.primary.main, 0.4)}` },
                  transition: 'all 0.3s ease',
                }}
              >
                Purchase a Plan
  ...
  const calculateProgress = () => {
    if (!planData.createdAt || !planData.expiresAt) return 0;
    const total = new Date(planData.expiresAt) - new Date(planData.createdAt);
    const elapsed = new Date() - new Date(planData.createdAt);
  ...
  const formatAddOnDate = (dateString) => {
    const date = new Date(dateString);
    ...
    >
      ...
      >
        ...
        <Box sx={{
          ...
          mb: { xs: 1.2, sm: 1.5 }, pb: { xs: 1.2, sm: 1.5 },
          borderBottom: "2px solid", borderColor: alpha(statusColor, 0.1),
          gap: { xs: 0.8, sm: 0 }
        }}>
          <Box sx={{ display: "flex", alignItems: "center", gap: 0.8 }}>
            <Box sx={{
              width: { xs: 6, sm: 8 }, height: { xs: 6, sm: 8 }, borderRadius: "50%", bgcolor: statusColor,
              animation: daysLeft <= 7 ? "pulse 2s infinite" : "none",
              "@keyframes pulse": { "0%": { opacity: 1, transform: "scale(1)" }, "50%": { opacity: 0.5, transform: "scale(1.2)" }, "100%": { opacity: 1, transform: "scale(1)" } },
            }} />
            <Typography variant={isMobile ? "body1" : "h6"} fontWeight="600" sx={{ color: theme.palette.primary.main, fontSize: { xs: '0.9rem', sm: '1rem', md: '1.1rem' } }}>
              Current Plan
            </Typography>
          </Box>
          {!isSubAdmin && (
          ...
          <Grid item xs={6} md={3}>
            <Box sx={{ bgcolor: alpha(statusColor, 0.03), p: { xs: 0.8, sm: 1, md: 1.2 }, borderRadius: 1.5, border: "1px solid", borderColor: alpha(statusColor, 0.1), height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <Chip
                ...
                sx={{ bgcolor: alpha(planData.isActive ? theme.palette.primary.main : theme.palette.text.secondary, 0.1), color: planData.isActive ? theme.palette.primary.main : theme.palette.text.secondary, fontWeight: 600, fontSize: '0.6rem', height: 18, mt: 0.3, alignSelf: 'flex-start' }}
              />
            </Box>
          </Grid>
        </Grid>
          ...
          <Box sx={{ mb: { xs: 1.2, sm: 1.5 } }}>
            <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 0.5 }}>
              ...
              <Chip label={daysLeft <= 0 ? "Expired" : `${daysLeft} days left`} size="small"
                sx={{ bgcolor: alpha(statusColor, 0.1), color: statusColor, height: 18, fontSize: "0.6rem", fontWeight: 600 }} />
            </Box>
          ...
          <>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.6 }}>
                <Typography variant="caption" fontWeight={700} sx={{ fontSize: '0.65rem', color: theme.palette.primary.main, textTransform: 'uppercase', letterSpacing: 0.5 }}>
              ...
              >
                <Box
                  ...
                  sx={{
                    ...
                    transform: addOnsOpen ? 'rotate(180deg)' : 'rotate(0deg)',
            ...
            {/* First 2 most recent completed add-ons shown inline */}
            {recent2AddOns.length > 0 && (
              <Grid container spacing={1} sx={{ mb: addOnsOpen ? 1 : 0 }}>
                    ...
                    <Box sx={{
                      ...
                      <Typography sx={{ fontSize: '0.55rem', fontWeight: 600, color: 'text.primary' }}>
                        ...
                        {addOn.addOnDiscountAmount > 0 && (
                          <Box component="span" sx={{ ml: 0.4, fontSize: '0.5rem', color: '#22c55e' }}>
                      ...
                      <Typography sx={{ fontSize: '0.45rem', color: 'text.disabled', mt: 0.3 }}>
                        {formatAddOnDateTime(addOn.createdAt)}
                      </Typography>
                    </Box>
                  </Grid>
                ))}
            ...
            {/* Dropdown list — all completed add-ons (sorted newest first) */}
            <AnimatePresence>
              {addOnsOpen && (
                <motion.div
                ...
                >
                  ...
                  >
                    {allCompletedForList.map((addOn, idx) => (
                      <Box
                        key={addOn._id || idx}
                        sx={{
                          display: 'flex', alignItems: 'center', gap: 1,
                          px: 1.2, py: 0.8,
                          borderBottom: idx < allCompletedForList.length - 1 ? `1px solid ${alpha(theme.palette.divider, 0.5)}` : 'none',
                          bgcolor: idx < 2 ? alpha(theme.palette.primary.main, 0.03) : 'transparent',
                      ...
                      >
                        ...
                        <Typography sx={{ 
                          ...
                          {formatAddOnDate(addOn.createdAt)}
                        </Typography>
                        ...
                        <Box sx={{ 
                          ...
                          <Typography sx={{ fontSize: '0.45rem', color: '#22c55e', lineHeight: 1 }}>
                            users
                          </Typography>
                        </Box>
                        ...
                        <Box sx={{ flex: 1, minWidth: 0 }}>
                          <Typography noWrap sx={{ fontSize: '0.58rem', fontWeight: 600, color: 'text.primary' }}>
                            {addOn.addOnDescription || 'Add-on plan'}
                          </Typography>
                          <Typography sx={{ fontSize: '0.5rem', color: 'text.secondary' }}>
                            ₹{addOn.addOnAmount}
                            {addOn.addOnDiscountAmount > 0 && (
                              <Box component="span" sx={{ ml: 0.3, color: '#22c55e' }}>
                                (-₹{addOn.addOnDiscountAmount})
                              </Box>
                            )}
                            {addOn.addOnCouponCode && (
                              <Box component="span" sx={{ ml: 0.3, color: theme.palette.primary.main }}>
                                • {addOn.addOnCouponCode}
                              </Box>
                            )}
                          </Typography>
                        ...
                        {/* Time */}
                        <Typography sx={{ fontSize: '0.48rem', color: 'text.disabled', textAlign: 'right', whiteSpace: 'nowrap' }}>
                          {new Date(addOn.createdAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                        </Typography>
                      </Box>
                    ))}
                  </Box>
