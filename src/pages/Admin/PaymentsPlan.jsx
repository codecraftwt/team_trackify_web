...
//   // Limit to show only last 10 payments
//   const limitedPaymentHistory = paymentHistory?.slice(0, 10) || [];
...
//   useEffect(() => {
//     if (userData?.currentPaymentId) {
//       const expired = moment(userData.currentPaymentId.expiresAt).isBefore(moment());
//       setIsExpired(expired);
//       setHasActiveSubscription(!expired);
//       if (userData.currentPaymentId.expiresAt) {
//         setSubscriptionExpiry(userData.currentPaymentId.expiresAt);
//       }
//       setCurrentPlanDetails({
...
//     const isDisabled = isAddOn 
//       ? (!hasActiveSubscription || isExpired)
//       : (!isAddOn && hasActiveSubscription && !isCurrentPlan && !isExpired);
//     const isRecommended = plan.name === "Enterprise Plan" && !isAddOn;
//     const hasCouponApplied = appliedCouponData && selectedPlanForCoupon?._id === plan._id;
...
//               borderRadius: 2.5,
//               border: '1px solid',
//               borderColor: isRecommended ? theme.palette.primary.main : (isCurrentPlan && !isExpired ? theme.palette.primary.main : alpha(theme.palette.divider, 0.5)),
//               boxShadow: isRecommended
//                 ? `0 8px 25px -8px ${alpha(theme.palette.primary.main, 0.5)}`
...
//               {/* Payment Stats for completed plans */}
//               {paymentStats && isCurrentPlan && !isExpired && (
//                 <Box sx={{ mt: 2, p: 1, bgcolor: alpha(theme.palette.success.main, 0.1), borderRadius: 1.5 }}>
//                   <Typography variant="caption" sx={{ color: theme.palette.success.main, fontWeight: 600, display: 'block', textAlign: 'center' }}>
//                     ✓ Active Plan
//                   </Typography>
...
//             <CardActions sx={{ p: 2.5, pt: 0 }}>
//               {!isAddOn && hasActiveSubscription && !isExpired ? (
//                 isCurrentPlan ? (
//                   <Button
//                     fullWidth
//                     variant="contained"
...
//                     borderRadius: 2.5,
//                     border: '2px solid',
//                     borderColor: isCustomPlanPurchased && !isExpired ? theme.palette.success.main : '#9c27b0',
//                     boxShadow: `0 8px 25px -8px ${alpha(isCustomPlanPurchased && !isExpired ? theme.palette.success.main : '#9c27b0', 0.5)}`,
//                     transition: 'all 0.3s ease',
//                     height: '100%',
//                     display: 'flex',
//                     flexDirection: 'column',
//                     '&:hover': {
//                       transform: 'translateY(-6px)',
//                       boxShadow: `0 25px 40px -15px ${alpha(isCustomPlanPurchased && !isExpired ? theme.palette.success.main : '#9c27b0', 0.6)}`,
//                       borderColor: isCustomPlanPurchased && !isExpired ? theme.palette.success.main : '#9c27b0',
//                     },
//                   }}
//                 >
...
//                       right: -30,
//                       zIndex: 10,
//                       background: isCustomPlanPurchased && !isExpired ? theme.palette.success.main : (isCustomPlanPurchased && isExpired ? theme.palette.warning.main : '#df3a24b1'),
//                       color: 'white',
//                       fontWeight: 600,
//                       fontSize: '0.6rem',
//                       py: 0.4,
...
//                     }}
//                   >
//                     {isCustomPlanPurchased && !isExpired ? 'ACTIVE' : (isCustomPlanPurchased && isExpired ? 'EXPIRED' : 'YOUR PLAN')}
//                   </Box>

//                   {/* Header */}
//                   <CardHeader
//                     sx={{
//                       background: `linear-gradient(135deg, ${isCustomPlanPurchased && !isExpired ? theme.palette.success.main : (isCustomPlanPurchased && isExpired ? theme.palette.warning.main : '#9c27b0')}, ${isCustomPlanPurchased && !isExpired ? theme.palette.success.dark : (isCustomPlanPurchased && isExpired ? theme.palette.warning.dark : '#7b1fa2')})`,
//                       color: 'white',
//                       py: 2,
//                       px: 2.5,
//                       borderTopLeftRadius: 10,
...
//                         sx={{
//                           bgcolor: 'white',
//                           color: isCustomPlanPurchased && !isExpired ? theme.palette.success.main : '#9c27b0',
//                           fontWeight: 600,
//                           fontSize: '0.6rem',
//                           height: 22,
//                         }}
...
//                     {isCustomPlanPurchased && !isExpired && (
//                       <Box sx={{ mt: 2, p: 1, bgcolor: alpha(theme.palette.success.main, 0.1), borderRadius: 1.5, textAlign: 'center' }}>
//                         <Typography variant="caption" sx={{ color: theme.palette.success.main, fontWeight: 600 }}>
//                           ✓ You have an active subscription for this plan
//                         </Typography>
...
//                           variant="contained"
//                           onClick={handlePurchaseCustomPlan}
//                           disabled={hasActiveSubscription && !isExpired}
//                           startIcon={<CreditCardIcon sx={{ fontSize: 16 }} />}
//                           size="small"
//                           sx={{
//                             py: 1.2,
