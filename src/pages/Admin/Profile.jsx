    ...
    <>
      ...
      <Box sx={{ p: { xs: 1, sm: 1.5, md: 2 }, minHeight: "100vh", background: `linear-gradient(155deg, ${alpha(theme.palette.primary.main, 0.03)} 0%, ${theme.palette.background.default} 40%)` }}>
        ...
        <motion.div initial="hidden" animate="visible" variants={containerVariants}>
          ...
          {/* ── Profile Header Card ── */}
          <Paper elevation={0} sx={{ borderRadius: 2.5, border: "1px solid", borderColor: alpha(theme.palette.primary.main, 0.1), mb: 1.5, boxShadow: `0 2px 10px -6px ${alpha(theme.palette.primary.main, 0.1)}` }}>
            <Box sx={{ px: { xs: 1.5, sm: 2 }, py: 1.5, display: "flex", alignItems: "center", gap: 1.5 }}>
              <Box sx={{ position: "relative", flexShrink: 0 }}>
                {previewImage
                  ? <Avatar src={previewImage} sx={{ width: { xs: 46, sm: 52 }, height: { xs: 46, sm: 52 }, boxShadow: `0 2px 8px ${alpha(theme.palette.primary.main, 0.18)}` }} />
                  : <Avatar sx={{ width: { xs: 46, sm: 52 }, height: { xs: 46, sm: 52 }, bgcolor: alpha(theme.palette.primary.main, 0.1), color: theme.palette.primary.main, boxShadow: `0 2px 8px ${alpha(theme.palette.primary.main, 0.12)}` }}><PersonIcon sx={{ fontSize: { xs: 22, sm: 25 } }} /></Avatar>
                }
                {isEditing && (
                  <Tooltip title="Change Photo">
                    <IconButton size="small" component="label" sx={{ position: "absolute", bottom: 0, right: 0, background: `linear-gradient(135deg, ${theme.palette.primary.main}, ${theme.palette.primary.dark})`, color: "white", width: 18, height: 18, "&:hover": { background: `linear-gradient(135deg, ${theme.palette.primary.dark}, ${theme.palette.primary.main})` } }}>
                      <CameraIcon sx={{ fontSize: 10 }} />
                      <input type="file" hidden accept="image/*" onChange={handleImageChange} />
                    </IconButton>
                  </Tooltip>
                )}
