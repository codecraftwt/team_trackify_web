...
//   const [avatarKey, setAvatarKey] = useState(0); // Add this to force avatar re-render
...
//         // Always fetch fresh user data when component mounts or user ID changes
...
//       } else {
//         console.log('No avatar for user:', userData._id);
...
//       await dispatch(updateUser({ userId: userData._id, formData: payload })).unwrap();
//       await dispatch(getUserById(userData._id));
//       setAvatarKey(prev => prev + 1); // Force avatar re-render after update
//       toast.success("Profile updated!");
//       setIsEditing(false);
//     } catch (error) {
//       if (error?.errors && Array.isArray(error.errors) && error.errors.length > 0) {
...
//                       {previewImage ? (
//                         <Avatar
//                           key={`avatar-${userData?._id}-${avatarKey}`}
//                           src={previewImage}
//                           sx={{
//                             width: { xs: 70, sm: 80 },
//                             height: { xs: 70, sm: 80 },
...
//                       ) : (
//                         <Avatar 
//                           key={`default-avatar-${userData?._id}-${avatarKey}`}
//                           sx={{
//                             width: { xs: 70, sm: 80 },
//                             height: { xs: 70, sm: 80 },
//                             bgcolor: alpha(theme.palette.primary.main, 0.1),
...
//                           }}
//                         >
//                           {userData?.name?.charAt(0)?.toUpperCase() || <PersonIcon sx={{ fontSize: { xs: 30, sm: 36 } }} />}
//                         </Avatar>
//                       )}
//                     </Box>
//                   </Badge>
...
//   // Derive role from Redux auth state only (never from localStorage directly)
//   const userRoleId = userData?.role_id || authState?.user?.role_id || authState?.role_id;
//   const isSuperAdmin = userRoleId === 2;
//   const isAdmin = userRoleId === 1;
//   const isSubAdmin = userRoleId === 3;
