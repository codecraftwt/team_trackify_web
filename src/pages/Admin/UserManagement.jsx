    ...
    <TableRow>
      ...
      <TableCell>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 1, sm: 2 } }}>
          ...
          <Skeleton variant="text" width={100} height={20} sx={{ bgcolor: alpha("#2563EB", 0.2) }} />
        </Box>
      </TableCell>
      <TableCell>
        <Skeleton variant="text" width={150} height={20} sx={{ bgcolor: alpha("#2563EB", 0.2) }} />
      </TableCell>
      <TableCell>
        <Skeleton variant="rounded" width={60} height={24} sx={{ borderRadius: 3, bgcolor: alpha("#2563EB", 0.2) }} />
      </TableCell>
      <TableCell>
        <Skeleton variant="text" width={80} height={20} sx={{ bgcolor: alpha("#2563EB", 0.2) }} />
      </TableCell>
      <TableCell align="right">
        <Box sx={{ display: 'flex', gap: 0.5, justifyContent: 'flex-end' }}>
          <Skeleton variant="circular" width={28} height={28} sx={{ bgcolor: alpha("#2563EB", 0.2) }} />
          <Skeleton variant="circular" width={28} height={28} sx={{ bgcolor: alpha("#2563EB", 0.2) }} />
          <Skeleton variant="circular" width={28} height={28} sx={{ bgcolor: alpha("#2563EB", 0.2) }} />
        </Box>
      </TableCell>
    ...
    <Grid item xs={12} sm={6} md={4}>
      ...
      >
        <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 1.5, sm: 2 }, mb: 2 }}>
            <Skeleton variant="circular" width={56} height={56} sx={{ bgcolor: alpha("#2563EB", 0.2) }} />
            <Box sx={{ flex: 1 }}>
              <Skeleton variant="text" width="80%" height={24} sx={{ mb: 1, bgcolor: alpha("#2563EB", 0.2) }} />
              <Skeleton variant="text" width="60%" height={16} sx={{ bgcolor: alpha("#2563EB", 0.2) }} />
            </Box>
          </Box>

          <Stack spacing={1.5} sx={{ mb: 2 }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
              <Skeleton variant="text" width={40} height={16} sx={{ bgcolor: alpha("#2563EB", 0.2) }} />
              <Skeleton variant="rounded" width={60} height={20} sx={{ borderRadius: 3, bgcolor: alpha("#2563EB", 0.2) }} />
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
              <Skeleton variant="text" width={40} height={16} sx={{ bgcolor: alpha("#2563EB", 0.2) }} />
              <Skeleton variant="text" width={80} height={16} sx={{ bgcolor: alpha("#2563EB", 0.2) }} />
            </Box>
          </Stack>
          ...
          {[1, 2, 3, 4, 5, 6].map((item) => (
            <Grid item xs={12} sm={6} md={4} key={item}>
              <Skeleton
                variant="rounded"
                height={200}
                sx={{ borderRadius: 3, bgcolor: alpha("#2563EB", 0.1) }}
              />
            </Grid>
          ))}
        </Grid>
      ...
      <Grid container spacing={2} alignItems="center">
        <Grid item xs={12} md={6}>
          <Skeleton 
            variant="rounded" 
            height={isMobile ? 40 : 56} 
            sx={{ borderRadius: { xs: 2, sm: 3 }, bgcolor: alpha("#2563EB", 0.1) }} 
          />
        </Grid>
        <Grid item xs={12} md={6}>
          <Box sx={{ 
            ...
            <Skeleton variant="rounded" width={isMobile ? 100 : 120} height={isMobile ? 36 : 40} sx={{ borderRadius: 2, bgcolor: alpha("#2563EB", 0.1) }} />
            <Skeleton variant="rounded" width={isMobile ? 100 : 120} height={isMobile ? 36 : 40} sx={{ borderRadius: 2, bgcolor: alpha("#2563EB", 0.1) }} />
          </Box>
        </Grid>
      </Grid>
...
const TabsSkeleton = ({ isMobile }) => {
  return (
    ...
    >
      <Box sx={{ borderBottom: 1, borderColor: alpha('#2563EB', 0.1), p: 2 }}>
        <Box sx={{ display: 'flex', gap: 2 }}>
          <Skeleton variant="rounded" width={isMobile ? 100 : 150} height={40} sx={{ borderRadius: 2, bgcolor: alpha("#2563EB", 0.1) }} />
          <Skeleton variant="rounded" width={isMobile ? 100 : 150} height={40} sx={{ borderRadius: 2, bgcolor: alpha("#2563EB", 0.1) }} />
        </Box>
      </Box>
      <Box sx={{ p: { xs: 1, sm: 2 } }}>
    ...
    >
      <Card
        sx={{
          ...
          boxShadow: isSelected ? `0 8px 20px -8px ${alpha('#2563EB', 0.5)}` : '0 2px 10px rgba(0,0,0,0.03)',
          transition: 'all 0.3s ease',
          height: '100%',
          '&:hover': {
            transform: !isMobile ? 'translateY(-4px)' : 'none',
            boxShadow: !isMobile ? `0 20px 30px -10px ${alpha('#2563EB', 0.2)}` : 'none',
            borderColor: '#2563EB',
          },
        }}
      >
    ...
    <TableContainer sx={{ 
      ...
      <Table sx={{ minWidth: isMobile ? 600 : isTablet ? 700 : 800 }}>
        <TableHead>
          <TableRow>
            {isBulkMode && <TableCell padding="checkbox" sx={{ pl: 2 }}></TableCell>}
            <TableCell sx={{ fontWeight: 600, fontSize: { xs: '0.75rem', sm: '0.8rem', md: '0.9rem' }, color: '#2563EB' }}>
              User
            </TableCell>
            <TableCell sx={{ fontWeight: 600, fontSize: { xs: '0.75rem', sm: '0.8rem', md: '0.9rem' }, color: '#2563EB' }}>
              Email
            ...
            <TableCell sx={{ fontWeight: 600, fontSize: { xs: '0.75rem', sm: '0.8rem', md: '0.9rem' }, color: '#2563EB' }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, cursor: 'pointer' }} onClick={onSort}>
                Joined Date
                {sortOrder === 'asc' ? <ArrowUpwardIcon fontSize="small" sx={{ color: '#2563EB' }} /> : <ArrowDownwardIcon fontSize="small" sx={{ color: '#2563EB' }} />}
              </Box>
            </TableCell>
            <TableCell align="right" sx={{ fontWeight: 600, fontSize: { xs: '0.75rem', sm: '0.8rem', md: '0.9rem' }, color: '#2563EB' }}>
              Actions
            </TableCell>
          </TableRow>
        </TableHead>
          ...
          <AnimatePresence>
            {users.map((user) => (
              <motion.tr
                ...
                onMouseEnter={(e) => {
                  if (!isMobile) {
                    e.currentTarget.style.backgroundColor = alpha('#2563EB', 0.05);
                  }
                }}
                onMouseLeave={(e) => {
                  if (!isMobile) {
...
const UserManagement = () => {
  ...
  const handleDownloadPDF = async () => {
    ...
    autoTable(doc, {
      ...
      startY: 50,
      styles: { fontSize: 9, cellPadding: 3 },
      headStyles: { fillColor: [37, 99, 235], textColor: 255 }, // #2563EB
      alternateRowStyles: { fillColor: [240, 240, 240] },
    });
      ...
      <Box sx={{ p: { xs: 1, sm: 2, md: 3 } }}>
        ...
        <Box sx={{ 
          ...
          <Box sx={{ 
            ...
            <Skeleton variant="circular" width={isMobile ? 36 : 40} height={isMobile ? 36 : 40} sx={{ bgcolor: alpha("#2563EB", 0.1) }} />
            <Skeleton variant="circular" width={isMobile ? 36 : 40} height={isMobile ? 36 : 40} sx={{ bgcolor: alpha("#2563EB", 0.1) }} />
            <Skeleton variant="circular" width={isMobile ? 36 : 40} height={isMobile ? 36 : 40} sx={{ bgcolor: alpha("#2563EB", 0.1) }} />
            <Skeleton variant="rounded" width={isMobile ? 100 : 120} height={isMobile ? 36 : 40} sx={{ borderRadius: 2, bgcolor: alpha("#2563EB", 0.1) }} />
            <Skeleton variant="rounded" width={isMobile ? 100 : 120} height={isMobile ? 36 : 40} sx={{ borderRadius: 2, bgcolor: alpha("#2563EB", 0.1) }} />
  ...
  return (
    <Box sx={{ p: { xs: 1, sm: 2, md: 3 } }}>
      ...
      >
        <Box sx={{ borderBottom: 1, borderColor: alpha('#2563EB', 0.1) }}>
          <Tabs
            value={tabValue}
            onChange={handleTabChange}
            variant={isMobile ? "fullWidth" : "standard"}
      ...
      >
        <DialogTitle sx={{ textAlign: 'center', pb: 1 }}>
          ...
          <Typography variant="h5" fontWeight={600} sx={{ fontSize: { xs: '1.2rem', sm: '1.5rem' }, color: '#1e293b' }}>
            {isExpired ? 'Subscription Expired' : 'User Limit Reached'}
          </Typography>
        </DialogTitle>
        <DialogContent>
