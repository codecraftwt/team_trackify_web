      ...
      >
        <Card sx={{ 
          ...
          <Box sx={{ textAlign: 'center', mb: 4 }}>
            ...
            <Typography variant="body2" sx={{ color: '#2563EB', fontWeight: 500, mt: 1 }}>
              For: {email}
            </Typography>
          </Box>
                  ...
                  endAdornment: (
                    <InputAdornment position="end">
                      <IconButton
                        ...
                        disabled={isLoading || openSuccessAlert}
                      >
                        {showPassword ? <VisibilityOffIcon sx={{ color: '#2563EB' }} /> : <VisibilityIcon sx={{ color: '#2563EB' }} />}
                      </IconButton>
                    </InputAdornment>
                  ),
                }}
                  ...
                  endAdornment: (
                    <InputAdornment position="end">
                      <IconButton
                        ...
                        disabled={isLoading || openSuccessAlert}
                      >
                        {showConfirmPassword ? <VisibilityOffIcon sx={{ color: '#2563EB' }} /> : <VisibilityIcon sx={{ color: '#2563EB' }} />}
                      </IconButton>
                    </InputAdornment>
                  ),
                }}
          ...
          <Divider sx={{ my: 3, borderColor: alpha('#2563EB', 0.1) }} />
          ...
          <Box sx={{ textAlign: 'center', mt: 2 }}>
            ...
            >
              <ArrowBackIcon fontSize="small" sx={{ color: '#2563EB' }} />
              <span style={{ color: '#2563EB' }}>Back to OTP Verification</span>
            </Link>
          </Box>
        </Card>
      </motion.div>
