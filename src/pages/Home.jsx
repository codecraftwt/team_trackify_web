...
const Home = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {/* Hero Section */}
      <section className="min-h-[100vh] flex items-center relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-blue-50 py-20 md:py-22">
        ...
        <div className="container-custom relative z-10">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight mb-8">
              Track Every Move.{' '}
              <span className="text-blue-600">Prove Every Visit.</span>
              <br className="hidden sm:block" /> Lead With Confidence.
            </h1>
            ...
            <p className="text-xl md:text-2xl text-gray-800 font-medium mb-10">
              No assumptions. No blind spots. Just{' '}
              <span className="text-blue-600 italic font-bold">clarity</span>.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
              <motion.button
                ...
                whileTap={{ scale: 0.96 }}
                onClick={handleGetStartedClick}
                className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold text-lg px-10 py-4 rounded-full flex items-center gap-2 shadow-lg transition-all duration-300"
              >
                Get Started <FiArrowRight />
              </motion.button>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.96 }}
                onClick={() => navigate('/contact')}
                className="border-2 border-blue-600 text-blue-600 hover:bg-blue-50 font-semibold text-lg px-10 py-4 rounded-full transition-all duration-300"
              >
                Book a Live Demo
              </motion.button>
            </div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Because Field Work Demands{' '}
                <span className="text-blue-600">More Than Trust</span>
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                Door-to-door visits. Client meetings. On-site services. Every
                movement matters. Trackify empowers you to:
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Built for Businesses That{' '}
              <span className="text-blue-600">Operate on the Field</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Whether you manage 10 people or 1,000 — Trackify scales with your
              operations.
          ...
          >
            {perfectFor.map((item, index) => (
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.1 * index }}
                className="inline-flex items-center gap-2 bg-white border border-gray-200 text-gray-700 px-5 py-3 rounded-full font-medium hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all duration-300 cursor-pointer"
              >
                {item}
              </motion.span>
            ))}
          ...
          <p className="text-center text-lg font-semibold text-gray-700">
            If your workforce moves,{' '}
            <span className="text-blue-600">Trackify tracks smarter.</span>
          </p>
        </div>
      </section>
  ...
  <div className="container-custom">
    ...
    <motion.div
      ...
      className="text-center mb-12"
    >
      <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-700 font-semibold text-sm px-4 py-1.5 rounded-full mb-5">
        <span className="relative flex h-2 w-2">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {features.map((feature, index) => (
        <motion.div
          ...
          className={`
            group relative bg-white rounded-xl border border-gray-100 
            shadow-sm hover:shadow-lg hover:border-blue-200/60
            transition-all duration-300 ease-out overflow-hidden
          `}
        >
          {/* Very subtle hover gradient */}
          ...
          <div className="p-6 md:p-7 relative z-10">
            ...
            {/* Tiny visual cue at bottom – optional, very subtle */}
            <div className="mt-5 h-0.5 w-10 bg-blue-200/50 group-hover:w-16 group-hover:bg-blue-500 rounded-full transition-all duration-400" />
          </div>
        </motion.div>
      ))}
    </div>
      ...
      <section className="section-padding bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="container-custom text-center">
          <motion.div
            ...
            className="max-w-3xl mx-auto"
          >
            <div className="inline-block bg-white/10 text-blue-300 font-semibold text-sm px-4 py-2 rounded-full mb-4">
              Performance Driven
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Turn Movement Into{' '}
              <span className="text-blue-400">Measurable Performance</span>
            </h2>
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
              Tracking isn't about surveillance. It's about smarter coordination,
              improved productivity, and stronger results.
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => navigate('/login')}
                className="bg-white text-blue-600 font-bold px-8 py-3 rounded-full hover:bg-gray-100 transition-colors flex items-center"
              >
                Start Free Trial <FiArrowRight className="ml-2" />
              </motion.button>
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => navigate('/contact')}
                className="border-2 border-white text-white font-bold px-8 py-3 rounded-full hover:bg-white hover:text-blue-600 transition-colors"
              >
                Book a Live Demo
              </motion.button>
            </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Businesses Choose{' '}
              <span className="text-blue-600">Team Trackify</span>
            </h2>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            {whyChoose.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.1 * index }}
                className="flex items-center gap-3 bg-white border border-gray-200 px-5 py-3 rounded-xl hover:border-blue-600 hover:shadow-lg transition-all duration-300"
              >
                {item.icon}
                <span className="font-semibold text-gray-900">{item.label}</span>
              </motion.div>
