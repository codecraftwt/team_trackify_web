...
//   // ✅ Pass selectedDate (backendFormattedDate) to Locations
//   const handleViewSingleSession = (session) => {
//     if (!session) return;
...
//         // ✅ Pass the selected date so Locations can use it
...
//         },
//         metadata: {
//           selectedDate: backendFormattedDate, // ✅ YYYY-MM-DD string
//           formattedDate: backendFormattedDate,
//           trackId: trackData?._id,
//           userId: trackData?.id || trackData?._id,
//           selectedSessionId: sessionId,
...
//       state: {
//         sessions: sessionsToSend,
//         selectedDate: backendFormattedDate, // ✅ Pass date here too
//         summary: {
//           date: selectedDate,
//           formattedDate: selectedDate.toLocaleDateString("en-US", {
//             weekday: "long",
...
//                     div::-webkit-scrollbar-track { background: ${alpha(theme.palette.primary.main, 0.1)}; border-radius: 4px; }
//                     div::-webkit-scrollbar-thumb { background: ${alpha(theme.palette.primary.main, 0.3)}; border-radius: 4px; }
...
//                       key={item.sessionId || index}
//                       className="border-0 shadow-sm"
//                       style={{ minWidth: "280px", maxWidth: "300px", borderRadius: "8px", flexShrink: 0 }}
//                     >
//                       <Card.Body className="p-2">
//                         <div className="d-flex flex-column">
//                           <div className="d-flex align-items-center mb-2">
...
//   // ✅ Updated: Send ALL sessions for the selected date to Locations
//   const handleViewSingleSession = (clickedSession) => {
//     if (!sessionsData || sessionsData.length === 0) return;

//     // Send ALL sessions for the selected date
//     const allSessionsForDate = sessionsData.map((session) => ({
//       ...session,
//       userId: trackData?._id,
//     }));
...
//     navigate(`/locations`, {
//       state: {
//         sessions: allSessionsForDate, // All sessions for the selected date
//         selectedSessionId: clickedSession.sessionId || clickedSession._id, // The clicked session ID
//         selectedDate: backendFormattedDate,
//         summary: {
//           date: selectedDate,
//           formattedDate: selectedDate.toLocaleDateString("en-US", {
...
//           trackId: trackData?._id,
//           userId: trackData?.id || trackData?._id,
//           selectedSessionId: clickedSession.sessionId || clickedSession._id,
//         },
//       },
//     });
//   };
...
/////// Deepseek but shear all response
import React, { useState, useEffect } from "react";
import Calendar from "react-calendar";
import "react-calendar/dist/Calendar.css";
import {
